...
class Critic(nn.Module):
    def __init__(self, model_path=None, K=1):
        ...
        self.branches = nn.ModuleList([nn.Sequential(nn.Dropout(0.5),
                                                     nn.Linear(515, 1)) for _ in range(K)])
    ...
    def forward(self, x, a, k=0, in_layer='conv1', out_layer='fc6'):
        #
    ...
    def load_mat_model(self, matfile):
        ...
        mat_layers = list(mat['layers_new'])[0]
...
if __name__ == '__main__':
    ...
    # print(net)
    net = net.cuda()
    a = torch.FloatTensor(3, 3).cuda()
    x = torch.FloatTensor(3, 3, 127, 127).cuda()
    net.eval()
    out = net(x, a).squeeze(1)
    print(out)